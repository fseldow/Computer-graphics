...
public class TranslationManipulator extends Manipulator {
	...
	public void applyTransformation(Vector2 lastMousePos, Vector2 curMousePos, Matrix4 viewProjection) {
		...
		switch(this.axis) {
		case X:
			this.reference.translation.mulAfter(Matrix4.createTranslation(new Vector3(t2-t1, 0f, 0f)));
			break;
		case Y:
			this.reference.translation.mulAfter(Matrix4.createTranslation(new Vector3(0f, t2-t1, 0f)));
			break;
		case Z:
			this.reference.translation.mulAfter(Matrix4.createTranslation(new Vector3(0f, 0f, t2-t1)));
			break;
		default:
			break;
		}
